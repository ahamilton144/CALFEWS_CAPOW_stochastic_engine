...
def run(output_suffix):
    ...
    # Simulation data
    sim_weather=pd.read_csv('Synthetic_weather/output/synthetic_weather_data' + output_suffix + '.csv',header=0)
    ...
    df_leap.to_csv('Synthetic_streamflows/output/ORCA_forecast_flows' + output_suffix + '.csv')
